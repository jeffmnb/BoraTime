...
export const ModalSignOut = ({ onPressOut, onPressNo, onPressYes }) => {
    return (
        <TouchableOpacity style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)' }} activeOpacity={1} onPress={onPressOut}>
            <View style={styles.container}>
                <Text style={styles.txtSignOut}>Deseja sair do <Text style={styles.txtBora}>Bora</Text><Text style={styles.txtTime}>Time</Text>?</Text>
